...
public:
	...
	static void ExtractTextKeepFormatting(std::string& InSection, std::string& OutSection, const std::string& SectionStart, const std::string& SectionEnd, uint32_t& Offset);
	static void ReadDownloadedFileIntoString(std::string& OutString, const std::string& FileName);
};
